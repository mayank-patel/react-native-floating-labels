...
var propTypes = {
    ...
    dirtyStyle: View.propTypes.style,
    cleanStyle: View.propTypes.style
};
...
var FloatingLabel = React.createClass({
    ...
    getInitialState() {
        ...
        dirtyStyle = this.props.dirtyStyle || dirtyStyle;
        cleanStyle = this.props.cleanStyle || cleanStyle;
    ...
    render() {
        var props = {
                ...
                enablesReturnKeyAutomatically: this.props
                ...
                secureTextEntry:
                    this.props.secureTextEntry || this.props.password, // Compatibility
